...
template <class Message, class Consumer> struct add_consumer_config {
  template <class Builder> void operator()(Builder &builder) {
...
namespace icon::api {
template <class... Config> auto setup_default_endpoint(Config &&...configs) {
...
template <class Message, class Consumer> auto consumer(Consumer &&consumer) {
